  ...
  return (
    <footer className="w-full bg-white border-t border-gray-200">
      <div className=" w-full ">
        ...
        <div className=" lg:mx-28 sm:px-4 md:px-6 lg:px-8 pt-8 sm:pt-10 md:pt-12 px-3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-12 mb-8 sm:mb-10 md:mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <button className="flex items-center gap-2 px-4 py-2 bg-[#e9631e] text-white rounded-lg hover:bg-green-600 transition-colors">
        ...
        <div className='w-full flex items-center justify-between py-14 mt-4 bg-[#f5f5f8] px-44'>
          <div className='flex gap-2 items-center'>
            <FaLocationDot className='text-orange-500' />
            <Text>Maxuel street, Frankfurt 2589 Germay</Text>
          </div>
          <div className='flex gap-2 items-center'>
            <FaPhoneAlt    className='text-orange-500' />
            <Text>(022) 666 888 0000</Text>
          </div>
          <div className='flex gap-2 items-center'>
            <TfiEmail   className='text-orange-500' />
            <Text>needhelp@gmail.com</Text>
          </div>
        </div>
        <div className="py-2 border-t border-gray-300 text-center bg-black text-white w-vw">
