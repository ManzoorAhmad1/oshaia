    ...
    <footer className="bg-white border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
          ...
          {/* Categories Column */}
          <div>
            <h3 className="text-black font-bold text-lg mb-6 uppercase tracking-wider">Categories</h3>
            <ul className="space-y-4">
              <li>
                <Link href="/concerts" className="text-blue-500 hover:text-orange-500 transition-colors text-sm">
                  Concerts
                </Link>
              </li>
              <li>
                <Link href="/festivals" className="text-blue-500 hover:text-orange-500 transition-colors text-sm">
                  Festivals
                </Link>
              </li>
              <li>
                <Link href="/clubbing" className="text-blue-500 hover:text-orange-500 transition-colors text-sm">
                  Clubbing
                </Link>
              </li>
              <li>
                <Link href="/theatre" className="text-blue-500 hover:text-orange-500 transition-colors text-sm">
                  Theatre
                </Link>
              </li>
            </ul>
        ...
        <div className="py-8 border-y border-gray-300 mb-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-semibold text-sm">Official Tickets</div>
                <div className="text-xs text-gray-500">Guaranteed authenticity</div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-gray-500">Quick & simple process</div>
              </div>
            </div>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-600 text-sm">Entertainment discovery and monetisation platform.</span>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-semibold text-sm">Download Our App</div>
          ...
          <div className="space-y-3">
            ...
            <div className="text-blue-500 text-sm">support@platinumlist.net</div>
            <div className="text-gray-500 text-sm">+971 4 123 4567</div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-3">
              ...
              <a href="#" className="p-2 bg-gray-100 rounded-lg hover:bg-pink-100 transition-colors">
                <svg className="w-4 h-4 text-gray-600" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-8 pt-6 border-t border-gray-300 text-center">
          <div className="text-gray-500 text-sm">
            ...
            <Link href="/terms" className="ml-2 hover:text-orange-500 transition-colors">Terms & Conditions</Link> | 
            <Link href="/privacy" className="ml-2 hover:text-orange-500 transition-colors">Privacy Policy</Link>
          </div>
        </div>
      </div>
    </footer>
