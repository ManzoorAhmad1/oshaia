...
const PartnersSection = () => {
  ...
  const partners = [
    { id: 1, name: 'Partner 1', logo: '/images/no-image.png' },
    { id: 2, name: 'Partner 2', logo: '/images/no-image.png' },
    { id: 3, name: 'Partner 3', logo: '/images/no-image.png' },
    { id: 4, name: 'Partner 4', logo: '/images/no-image.png' },
    { id: 5, name: 'Partner 5', logo: '/images/no-image.png' },
    { id: 6, name: 'Partner 6', logo: '/images/no-image.png' },
  ]
