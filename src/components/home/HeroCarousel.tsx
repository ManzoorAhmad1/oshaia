...
const HeroCarousel = () => {
    return (
        <div className="bg-white min-h-[60vh] sm:min-h-[80vh]">
            ...
            {/* HERO CARD */}
            <div className="relative max-w-full sm:max-w-[1920px] mx-auto px-2 sm:px-4 lg:px-8 xl:px-12 2xl:px-16 py-2 sm:py-4 lg:py-6">
                <div className="relative h-[160px] sm:h-[250px] md:h-[350px] lg:h-[580px] xl:h-[650px] 2xl:h-[720px] rounded-xl sm:rounded-2xl overflow-hidden shadow-xl sm:shadow-2xl">
                    <Image
                ...
                {/* FLOATING NAV */}
                <div className="relative -mt-2 sm:-mt-6 md:-mt-14 lg:-mt-20 xl:-mt-24 2xl:-mt-28 max-w-full sm:max-w-7xl mx-auto flex justify-center px-1 sm:px-4 z-10">
                    <div className="bg-[#0d2147] text-white w-full rounded-lg sm:rounded-2xl px-2 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20 py-2 sm:py-4 md:py-5 lg:py-6 flex items-center justify-center gap-2 sm:gap-4 md:gap-6 lg:gap-12 xl:gap-16 shadow-xl sm:shadow-2xl flex-wrap">
                ...
                {/* SEARCH BAR SECTION */}
                <div className="relative -mt-2 sm:-mt-6 md:-mt-8 max-w-full sm:max-w-[1600px] mx-auto px-1 sm:px-4">
                    <div className="bg-white rounded-lg sm:rounded-2xl shadow-md sm:shadow-lg border border-gray-100 px-2 sm:px-4 md:px-6 lg:px-8 xl:px-10 py-2 sm:py-6 md:py-8 lg:py-12 flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-2 sm:gap-4">

                        {/* Search */}
                        <div className="flex items-center gap-1 sm:gap-3 border-2 border-gray-200 rounded-full px-2 sm:px-4 md:px-5 lg:px-6 py-1 sm:py-2.5 lg:py-3 w-full lg:w-[420px] xl:w-[500px] 2xl:w-[600px] hover:border-orange-400 transition-colors">
