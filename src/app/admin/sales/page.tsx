...
const ComingSoon = ({ title, desc, Icon }: { title: string; desc: string; Icon: any }) => (
  <div className="p-6 lg:p-8">
    ...
    <div className="bg-white rounded-2xl border border-gray-200 p-20 text-center">
      ...
      <p className="text-sm text-gray-400 max-w-xs mx-auto">Detailed sales reports by event, date range, and ticket type.</p>
    </div>
  </div>
);
export default function SalesPage() {
  return <ComingSoon title="Sales Report" desc="Detailed sales breakdown by event and period" Icon={FileBarChart} />;
}
