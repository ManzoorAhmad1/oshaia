...
const ComingSoon = ({ title, desc, Icon }: { title: string; desc: string; Icon: any }) => (
  <div className="p-6 lg:p-8">
    ...
    <div className="bg-white rounded-2xl border border-gray-200 p-20 text-center">
      ...
      <p className="text-sm text-gray-400 max-w-xs mx-auto">Per-event growth analytics and performance breakdown.</p>
    </div>
  </div>
);
export default function GrowthPage() {
  return <ComingSoon title="Each Growth Event" desc="Track ticket sales growth per event" Icon={TrendingUp} />;
}
