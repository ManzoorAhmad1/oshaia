...
const ComingSoon = ({ title, desc, Icon }: { title: string; desc: string; Icon: any }) => (
  <div className="p-6 lg:p-8">
    ...
    <div className="bg-white rounded-2xl border border-gray-200 p-20 text-center">
      ...
      <p className="text-sm text-gray-400 max-w-xs mx-auto">Platform-wide insights and event performance metrics.</p>
    </div>
  </div>
);
export default function InsightsPage() {
  return <ComingSoon title="Insights" desc="Platform-wide analytics and event insights" Icon={BarChart3} />;
}
