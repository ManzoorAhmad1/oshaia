...
const ComingSoon = ({ title, desc, Icon }: { title: string; desc: string; Icon: any }) => (
  <div className="p-6 lg:p-8">
    ...
    <div className="bg-white rounded-2xl border border-gray-200 p-20 text-center">
      ...
      <p className="text-sm text-gray-400 max-w-xs mx-auto">Push and in-app notifications management for users and staff.</p>
    </div>
  </div>
);
export default function NotificationsPage() {
  return <ComingSoon title="Notification" desc="Manage push and in-app notifications" Icon={Bell} />;
}
