...
const ComingSoon = ({ title, desc, Icon }: { title: string; desc: string; Icon: any }) => (
  <div className="p-6 lg:p-8">
    ...
    <div className="bg-white rounded-2xl border border-gray-200 p-20 text-center">
      ...
      <p className="text-sm text-gray-400 max-w-xs mx-auto">Revenue tracking, profit margins, and financial summaries per event.</p>
    </div>
  </div>
);
export default function RevenuePage() {
  return <ComingSoon title="Revenue / Finance" desc="Revenue, profit, and financial reporting" Icon={Banknote} />;
}
